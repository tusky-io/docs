...
<Steps>
  ...
  <Step title="Transparent access">
    File retrieval works exactly the same whether backup is enabled or not. If the primary Walrus path is unavailable, the gateway can fall back to the backup copy.
  </Step>
</Steps>
...
| MIME types and custom metadata | Gateway configuration |
