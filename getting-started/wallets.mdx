...
| **Tusky infrastructure fee** | SUI | A 10% fee on top of the base storage cost, covering managed publishing, aggregation, encryption, indexing, and aggregator services. |
