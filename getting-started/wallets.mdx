...
Tusky uses a **prepaid wallet** system. You deposit SUI and WAL tokens into your Tusky wallet, and storage operations draw from that balance automatically. There is no free tier — all storage is paid at current Walrus network rates.
