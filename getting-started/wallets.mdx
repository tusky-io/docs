...
Use the dashboard cost calculator or the [estimation API](/api-reference/uploads/estimate-upload) to preview costs before uploading. Pass a list of file sizes to get a per-file breakdown and totals:
