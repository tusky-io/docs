...
Revoke a key instantly from the [API keys page](https://app.tusky.io/account/api-keys). Revocation takes effect immediately — any in-flight requests using the revoked key will fail.
...
<Note>
  If you suspect a key has been compromised, revoke it immediately from the dashboard at [app.tusky.io/account/api-keys](https://app.tusky.io/account/api-keys). Then create a new key and update your application.
</Note>
