...
```bash
curl https://api.tusky.io/v1/volumes \
...
- **Use volume variables** — never hardcode API keys in source code
...
- **Use separate keys per volume** — create distinct keys for development, staging, and production
