...
console.log("Transactions:", usage.transactions);
...
| Field | Type | Description |
| --- | --- | --- |
| `transactions` | `number` | Total transactions (uploads, extends, deletes) in the period. |
...
| `suiSpent` | `string` | SUI spent in the period (gas fees). |
