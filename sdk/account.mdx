...
console.log("Drives:", usage.driveCount);
...
| Field | Type | Description |
| --- | --- | --- |
| `storageBytes` | `number` | Total bytes currently stored across all drives. |
| `fileCount` | `number` | Total number of files across all drives. |
| `driveCount` | `number` | Number of active drives. |
