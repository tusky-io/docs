...
console.log("Environments:", usage.environmentCount);
...
| Field | Type | Description |
| --- | --- | --- |
| `storageBytes` | `number` | Total bytes currently stored across all environments. |
| `fileCount` | `number` | Total number of files across all environments. |
| `environmentCount` | `number` | Number of active environments. |
