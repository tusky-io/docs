...
<Tip>
  Use the [cost estimation endpoint](/api-reference/uploads/create-upload) to preview the storage cost in SUI before uploading. Cost = Walrus storage cost + 10% Tusky fee.
</Tip>
