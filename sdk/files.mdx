...
<Tip>
  Use the [cost estimation endpoint](/api-reference/uploads/estimate-upload) to preview the storage cost before uploading. Cost = Walrus storage cost (WAL) + gas fee (SUI). Tusky charges no infrastructure fee.
</Tip>
