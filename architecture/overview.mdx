...
<Steps>
  <Step title="Upload received">
    The file is sent to the Tusky REST API. For encrypted drives, the SDK encrypts the file client-side before transmission.
  </Step>
...
The central interface for all Tusky operations. Handles authentication, authorization, drive/file CRUD, and orchestrates the write and read paths.
...
| System | Purpose |
| --- | --- |
| **PostgreSQL** | Primary state store — drives, files, members, accounts, transaction history. |
