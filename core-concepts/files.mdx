...
<Tabs>
  ...
  <Tab title="Auto-extend">
    Enable **auto-extend** on a file or at the environment level. Tusky automatically renews the storage allocation before the current epochs expire, ensuring uninterrupted availability. Auto-extend charges are billed to your account.
  </Tab>
</Tabs>
