...
<CardGroup cols={2}>
  ...
  <Card title="Private environment" icon="lock">
    Files are **encrypted client-side** before upload. Encryption keys are stored as [Secrets](/core-concepts/secrets) and managed through [Sui Seal](https://docs.mystenlabs.com/seal). The encrypted blobs are readable from any Walrus aggregator, but the data is ciphertext without the decryption key. The Tusky SDK handles encryption and decryption transparently.
  </Card>
</CardGroup>
