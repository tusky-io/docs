...
<Warning>
  Ejected blobs are no longer served through your Tusky gateway. If you rely on Tusky gateway URLs, plan your migration before ejecting. See [Gateways](/core-concepts/gateways) for details.
</Warning>
