...
<Tabs>
  <Tab title="Dashboard">
    Navigate to **Settings → Wallet** in the [Tusky dashboard](https://app.tusky.io) to see current balances, recent transactions with costs and file references, and projected runway based on usage patterns.
  </Tab>
  <Tab title="SDK">
    ```typescript
