---
title: List Members
api: 'GET https://api.tusky.io/v2/vaults/{vaultId}/members'
---

List all members of a vault, including their roles.
...
```bash cURL
curl https://api.tusky.io/v2/vaults/vault_abc123def456/members \
