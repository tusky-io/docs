...
<ResponseField name="managed" type="boolean">`true` for Tusky-managed secrets (e.g., environment encryption keys), `false` for user-created.</ResponseField>
...
curl https://api.tusky.io/v2/secrets/tusky/environments/env_abc123/encryption \
  -H "Api-Key: YOUR_API_KEY"
```
