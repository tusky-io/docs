---
title: List Files
api: 'GET https://api.tusky.io/v2/vaults/{vaultId}/files'
---

List all files within a specific vault. Results are returned in reverse chronological order and paginated using cursor-based pagination.
...
```bash cURL
curl "https://api.tusky.io/v2/vaults/vault_abc123def456/files?limit=10&mimeType=application/pdf" \
