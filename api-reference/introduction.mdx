...
The Tusky API is a RESTful interface for managing decentralized storage on the [Sui Walrus](https://walrus.xyz) network. Use it to create vaults, upload and download files, manage access control, and configure private aggregators.
