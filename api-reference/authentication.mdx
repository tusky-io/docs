...
API keys are created and managed from the [Tusky Dashboard](https://dashboard.tusky.io) or the [API Keys endpoint](/api-reference/api-keys/create-api-key):

1. Sign in at [dashboard.tusky.io](https://dashboard.tusky.io).
...
- **Use volume variables** — store keys in env vars, not in source code
