---
title: List Vaults
api: 'GET https://api.tusky.io/v2/vaults'
---

List all vaults accessible to the authenticated user. Results are returned in reverse chronological order and paginated using cursor-based pagination.
...
<ParamField query="limit" type="number" default="20">
  Number of vaults to return per page. Minimum `1`, maximum `100`.
</ParamField>
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Vault object properties">
...
```bash cURL
curl "https://api.tusky.io/v2/vaults?limit=10" \
