...
<CardGroup cols={2}>
  ...
  <Card title="Drives & File Management" icon="folder-tree">
    Organize files into drives — encrypted containers with granular access control. Drives give you a familiar file-system abstraction on top of Walrus blobs.
  </Card>
  ...
  <Card title="SDK & API" icon="code">
    A TypeScript SDK and REST API let you integrate Tusky into any application. Upload, download, manage drives, and control access programmatically.
  </Card>
...
| Concept | Description |
| --- | --- |
| **Drives** | Encrypted containers that group files with shared access policies. |
| **Files** | Individual objects stored inside drives, encrypted and published to Walrus. |
| **Members** | Users or API keys granted access to a drive with role-based permissions. |
| **Aggregators** | Private HTTP endpoints for serving drive content over custom domains. |
